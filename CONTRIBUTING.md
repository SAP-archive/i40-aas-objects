# Contributing to SAP/i40-aas

You want to contribute to SAP/i40-aas? Welcome! Please read this document to understand what you can do:
...
## Contribute Code
You are welcome to contribute code to SAP/i40-aas in order to fix bugs or to implement new features.
