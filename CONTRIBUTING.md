# Contributing to i40-aas-objects

You want to contribute to *i40-aas-objects*? Welcome! Please read this document to understand what you can do:
...
## Contribute Code
You are welcome to contribute code to *i40-aas-objects* in order to fix bugs or to implement new features.

## Reporting Security Issues
If you find a security issue, please act responsibly and report it not in the public issue tracker, but directly to us, so we can fix it before it can be exploited.

## Contributor License Agreement Acceptance
When you contribute (code, documentation, or anything else), you have to be aware that your contribution is covered by the same [Apache 2.0 License](http://www.apache.org/licenses/LICENSE-2.0) that is applied to *i40-aas-objects* itself.
